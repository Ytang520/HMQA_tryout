...
body_part = [index_Spine_Base, index_Spine_Mid, index_Neck, index_Head, index_Shoulder_Left, index_Elbow_Left,
             ...
             index_Hand_Right, index_Hip_Left, index_Knee_Left, index_Ankle_Left, index_Foot_Left, index_Hip_Right,
             index_Knee_Right, index_Ankle_Right, index_Ankle_Right, index_Spine_Shoulder, index_Tip_Left,
             index_Thumb_Left, index_Tip_Right, index_Thumb_Right
             ]
            ...
            for node in range(X_.shape[2]):
                for channel in range(X_.shape[3]):
                    X_[batch, timestep, node, channel] = X[
                        timestep + (batch * num_timestep), channel + (node * num_channel)]
